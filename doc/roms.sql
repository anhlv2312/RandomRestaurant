...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 29, 2018 at 01:47 AM
...
('appertizers', 'Appetizers', NULL),
('beef_lamb_pork', 'Beef, Lamb & Pork', NULL),
('chef_recommended', 'Chef Recommended', NULL),
('chicken', 'Chicken', NULL),
('mains', 'Mains', NULL),
('thai_vietnamese', 'Thai & Vietnamese', NULL),
('vergetarian', 'Vegetarian', NULL);
...
INSERT INTO `users` (`user_id`, `password`, `first_name`, `last_name`, `phone`, `email`) VALUES
